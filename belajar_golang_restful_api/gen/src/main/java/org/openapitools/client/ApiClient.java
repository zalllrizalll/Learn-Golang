...
public class ApiClient {
    ...
    private String basePath = "http://localhost:3000/api";
    ...
    public ApiClient() {
        ...
        authentications.put("CategoryAuth", new ApiKeyAuth("header", "X-API-Key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:3000/api
